...
DEFAULT_SETTINGS: Dict[str, Any] = {'ghidra_install_dir': '', 'use_ghidra': True, 'input_dll': '', 'jar_path': '', 'use_jar': False, 'decompile_jar': True, 'out_dir': '', 'mode': 'AUTO', 'force': False, 'pseudo_c': '', 'functions_json': '', 'strings_json': '', 'window_width': 1280, 'window_height': 860}
